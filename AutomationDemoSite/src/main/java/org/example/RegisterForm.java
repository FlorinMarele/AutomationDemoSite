...
public class RegisterForm {
    ...
    // Finding the corresponding locators.
    ...
    // Itiating the actions to fill the fields, click the buttons, selecting from the dropdowns and checkboxes and verifying the data.
